						...
						<div class="sns-login">
							<ul class="sns-login-list">
								<li><a href="javascript:loginWithNaver()"><img
										src="/resources/img/naver.png" alt="네이버 로그인" class="sns-icon"></a></li>
								<li><a href="javascript:loginWithApple()"><img
										src="/resources/img/apple.png" alt="애플 로그인" class="sns-icon"></a></li>
								<li><a href="javascript:loginWithKakao()"><img
										src="/resources/img/kakao.png" alt="카카오 로그인" class="sns-icon"></a></li>
							</ul>
						</div>
					</div>
				</div>
