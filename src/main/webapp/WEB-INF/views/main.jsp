...
<body>
	...
	<div class="wrap">
		<div class="content_area">
			...
			<div class="product-container">
				<h2 class="product-MDrecommend">${memberId}님 이런 상품은 어때요?</h2>
			...
			<div class="product-container">
				<h2 class="product-MDrecommend">인기 급상승! 랭킹 TOP 10</h2>
				<c:forEach var="item" items="${productList2}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
			...
			<div class="product-container">
				...
				<c:forEach var="item" items="${productList3}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
			...
			<div class="product-container">
				...
				<c:forEach var="item" items="${productList4}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
			...
			<div class="product-container">
				...
				<c:forEach var="item" items="${productList5}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
			...
			<div class="product-container">
				...
				<c:forEach var="item" items="${productList6}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
			...
			<div class="product-container">
				<h2 class="product-MDrecommend">🌟랭킹UP! 이달의 신상품🌟</h2>
				<c:forEach var="item" items="${productList7}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
			...
			<div class="product-container">
				<h2 class="product-MDrecommend">인기 카테고리 상품</h2>
				<c:forEach var="item" items="${productList8}">
					<div class="product-card">
						<a
							href="${pageContext.request.contextPath}/goodsDetail/${item.itemId}">
							<c:choose>
