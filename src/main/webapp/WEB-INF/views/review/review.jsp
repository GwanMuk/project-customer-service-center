    ...
    <div class="main_content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body table-container">
                ...
                <%-- <div class='row'>
                    <div class="col-lg-12">
                        <form id='findForm' action="/review/review/${member.memberId}" method='get'>
                            <select name='type'>
                ...
                <button id='regBtn' type="button" class="btn btn-xs pull-right btn-info">리뷰쓰기</button>
            </div>
                <form id='actionForm' action="/review/review/${member.memberId}" method='get'>
